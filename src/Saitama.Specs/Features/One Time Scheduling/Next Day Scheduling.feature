...
Scenario Outline: Schedule a job to run tomorrow [outline]
    Given today is <current date and time>
      And a job is configured to run tomorrow
     When scheduled
     Then it should run once sometime on the following <day of week to run>

    Examples: 
   | current date and time      | day of week to run        |
...
Scenario Outline: Schedule a job to run tomorrow at a certain time [outline]
    Given today is <current date and time>
      And a job is configured to run tomorrow at time
     When scheduled
     Then it should run once the on <date and time to run>

    Examples: 
   | current date and time            | date and time to run            |
